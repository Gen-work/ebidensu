...
function Get-ConfigOverlayReadmeText {
    ...
    $lines = @(
        ...
        '- excel: Workbook/ExcelSnap/Review/Replace/CheckSheet/SendVsGift/GfixLog Excel-related settings.',
        ...
        '  OffsetX/OffsetY/Width/Height when no template match is found.',
        '- Mark.NoteStamps: stamp image (e.g. already_exists.png) inserted next',
        '  to a verifyNote annotation, keyed by its Folder (only GIFT_noGfixfile',
        '  today); Image/Column/RowOffset. See mark_templates/README.txt.',
